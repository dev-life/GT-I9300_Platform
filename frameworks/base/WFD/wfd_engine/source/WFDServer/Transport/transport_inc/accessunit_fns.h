...
extern int write_access_unit_as_TS_with_pts_dts(void *id, 
												char*  data, 
...
extern int write_access_unit_as_TS_with_PCR(void *id, 
											char *data,
                                            unsigned int data_len,
                                            uint32_t               video_pid,
                                            uint64_t               pcr_base,
...
/*
 * made by ghryu 
 * Manage dts value globally  
 * 
 */
extern uint64_t get_dts_value (); 

extern uint64_t get_video_dts(); 
