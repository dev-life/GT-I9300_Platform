...
{
	/* struct hdp_device *dev = data; */
// BEGIN SS_BLUEZ_BT +veera 2011.12.02
	struct hdp_device *dev = data;
	struct hdp_channel *chan;
	GSList *l;
// END SS_BLUEZ_BT
...
static GDBusSignalTable health_device_signals[] = {
	{"ChannelConnected",		"o"		},
// BEGIN SS_BLUEZ_BT +veera 2012.12.02
// 'ChannelClosed' signal is launched when a data channel is closed.
	{"ChannelClosed",		"o"		},
// END SS_BLUEZ_BT
	{"ChannelDeleted",		"o"		},
	{"PropertyChanged",		"sv"		},
