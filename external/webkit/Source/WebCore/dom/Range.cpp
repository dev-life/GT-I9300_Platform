...
//SAMSUNG CHANGe >> Merged from P1 Gingerbread to ICS - This code fixes MPSG3078 - Start
void Range::setRect(int x, int y, int width, int height, ExceptionCode& ec)
{
    ...
    setStart(start.anchorNode(), start.deprecatedEditingOffset(), ec) ;
    if(ec)
        return;

    setEnd(end.anchorNode(), end.deprecatedEditingOffset(), ec) ;
}
//SAMSUNG CHANGE << Merged from P1 Gingerbread to ICS - This code fixes MPSG3078 - End
...
//SAMSUNG CHANGE >>
Vector<IntRect> Range::boundingBoxEx()//arvind.maan RTL selection fix
{
    IntRect result;
    Vector<IntRect> rects;
