...
void Frame::lspellcheck()
{
    ...
    WebCore::IntPoint wndPoint = view()->contentsToWindow(contentsPoint);

    WebCore::MouseEventType met1 = WebCore::MouseEventMoved;
    WebCore::PlatformMouseEvent pme1(wndPoint, contentsPoint, WebCore::NoButton,met1,false,false,false,false,false,0);
