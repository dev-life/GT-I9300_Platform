...
#ifndef BROWSER_SPELLCHECK_DICTIONARY_H
#define BROWSER_SPELLCHECK_DICTIONARY_H
...
public:
    ...
    int getSuggestionsTest(unsigned short *word, int length, unsigned short *outWords, int *frequencies,
...
private:
    ...
    void getWordsRecTest(int pos, int depth, int maxDepth, bool completion, int snr, int inputIndex,int iffs);
    ...
    int *mInputCodes;
    unsigned short *mInputCodesTest;
    int mInputLength;
...
#endif // BROWSER_SPELLCHECK_DICTIONARY_H
