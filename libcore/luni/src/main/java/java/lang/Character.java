...
public final class Character implements Serializable, Comparable<Character> {
    ...
    public static boolean isLetterOrDigitOrSpecialChar(char c) {
        return isLetterOrDigitOrSpecialChar((int) c);
    }

    public static boolean isLetterOrDigitOrSpecialChar(int codePoint) {
        // Optimized case for ASCII
        if (('A' <= codePoint && codePoint <= 'Z') || ('a' <= codePoint && codePoint <= 'z')) {
            return true;
        }
